...
namespace CosmosMongoIntegrationTests;

// ReSharper disable RedundantOverriddenMember

public class CosmosMongoTypeTests(CosmosMongoTypeTests.Fixture fixture)
    : TypeTests<string>(fixture), IClassFixture<CosmosMongoTypeTests.Fixture>
{
